...
import com.synopsys.integration.polaris.common.api.generated.auth.Entitlement;
...
public class EntitlementResources extends PolarisComponent {
    ...
    public EntitlementResources addDataItem(Entitlement dataItem) {
        if (this.data == null) {
    ...
    public void setData(List<Entitlement> data) {
        this.data = data;
    }
