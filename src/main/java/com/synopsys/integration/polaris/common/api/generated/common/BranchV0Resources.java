...
import com.synopsys.integration.polaris.common.api.generated.common.JsonApiIncludedResource;
import com.synopsys.integration.polaris.common.api.generated.common.LinksPagination;
...
public class BranchV0Resources extends PolarisComponent {
    @SerializedName("data")
     private List<BranchV0> data = new ArrayList<>();
    ...
    public BranchV0Resources addDataItem(BranchV0 dataItem) {
     ...
     * @return data
     */
    public List<BranchV0> getData() {
        return data;
    }

    public void setData(List<BranchV0> data) {
        this.data = data;
    }
    ...
    public BranchV0Resources addIncludedItem(JsonApiIncludedResource includedItem) {
