...
import com.synopsys.integration.polaris.common.api.generated.auth.TermsOfUse;
...
public class TermsOfUseResources extends PolarisComponent {
    ...
    public TermsOfUseResources addDataItem(TermsOfUse dataItem) {
        if (this.data == null) {
    ...
    public void setData(List<TermsOfUse> data) {
        this.data = data;
    }
