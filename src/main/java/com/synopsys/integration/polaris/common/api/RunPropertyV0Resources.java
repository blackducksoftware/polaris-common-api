...
import com.synopsys.integration.polaris.common.api.RunPropertyV0;
...
public class RunPropertyV0Resources extends Stringable {
    @SerializedName("data")
    ...
    public RunPropertyV0Resources addDataItem(RunPropertyV0 dataItem) {
    ...
    public void setData(List<RunPropertyV0> data) {
        this.data = data;
    }
