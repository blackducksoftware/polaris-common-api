...
import com.synopsys.integration.polaris.common.api.generated.auth.Inclusion;
...
public class IncludedRelationsParams extends PolarisComponent {
    ...
    public IncludedRelationsParams addParamsItem(Inclusion paramsItem) {
        if (this.params == null) {
    ...
    public void setParams(List<Inclusion> params) {
        this.params = params;
    }
