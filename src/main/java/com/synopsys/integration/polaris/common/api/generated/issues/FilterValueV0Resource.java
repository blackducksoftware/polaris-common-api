...
import com.synopsys.integration.polaris.common.api.generated.issues.FilterValueV0;
...
public class FilterValueV0Resource extends PolarisComponent {
    ...
    public FilterValueV0Resource addDataItem(FilterValueV0 dataItem) {
        if (this.data == null) {
    ...
    public void setData(List<FilterValueV0> data) {
        this.data = data;
    }
