...
import com.synopsys.integration.polaris.common.api.generated.issues.CountV0;
...
public class CountV0Resources extends PolarisComponent {
    ...
    public CountV0Resources addDataItem(CountV0 dataItem) {
    ...
    public void setData(List<CountV0> data) {
        this.data = data;
    }

    public CountV0Resources addIncludedItem(JsonApiIncludedResource includedItem) {
