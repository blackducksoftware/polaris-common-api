...
public class ProjectV0Resources extends PolarisComponent {
    @SerializedName("data")
     private List<ProjectV0> data = new ArrayList<>();
    ...
    public ProjectV0Resources addDataItem(ProjectV0 dataItem) {
     ...
     * @return data
     */
    public List<ProjectV0> getData() {
        return data;
    }

    public void setData(List<ProjectV0> data) {
        this.data = data;
    }
