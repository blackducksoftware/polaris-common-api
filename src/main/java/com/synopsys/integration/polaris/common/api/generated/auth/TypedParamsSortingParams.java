...
import com.synopsys.integration.polaris.common.api.generated.auth.SortingParams;
...
public class TypedParamsSortingParams extends PolarisComponent {
    ...
    public TypedParamsSortingParams putParamsItem(String key, SortingParams paramsItem) {
        if (this.params == null) {
    ...
    public void setParams(Map<String, SortingParams> params) {
        this.params = params;
    }
