...
import com.synopsys.integration.polaris.common.api.generated.auth.Context;
...
public class ContextResources extends PolarisComponent {
    ...
    public ContextResources addDataItem(Context dataItem) {
        if (this.data == null) {
    ...
    public void setData(List<Context> data) {
        this.data = data;
    }
