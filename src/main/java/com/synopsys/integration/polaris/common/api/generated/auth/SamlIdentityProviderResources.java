...
import com.synopsys.integration.polaris.common.api.generated.auth.SamlIdentityProvider;
...
public class SamlIdentityProviderResources extends PolarisComponent {
    ...
    public SamlIdentityProviderResources addDataItem(SamlIdentityProvider dataItem) {
        if (this.data == null) {
    ...
    public void setData(List<SamlIdentityProvider> data) {
        this.data = data;
    }
