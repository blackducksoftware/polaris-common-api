...
public class BranchV0Resources extends PolarisComponent {
    ...
    public BranchV0Resources addDataItem(final BranchV0 dataItem) {
    ...
    public void setData(final List<BranchV0> data) {
        this.data = data;
    }
    ...
    public BranchV0Resources addIncludedItem(final JsonApiIncludedResource includedItem) {
