...
import com.synopsys.integration.polaris.common.api.generated.issues.FilterKeyV0;
...
public class FilterKeyV0Resource extends PolarisComponent {
    ...
    public FilterKeyV0Resource addDataItem(FilterKeyV0 dataItem) {
        if (this.data == null) {
    ...
    public void setData(List<FilterKeyV0> data) {
        this.data = data;
    }
