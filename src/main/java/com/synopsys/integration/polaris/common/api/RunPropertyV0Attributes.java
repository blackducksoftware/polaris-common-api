...
public class RunPropertyV0Attributes extends Stringable {
/**
...
return null;
    ...
    public RunPropertyV0Attributes addStringListValueItem(String stringListValueItem) {
    ...
    public RunPropertyV0Attributes addReferenceListValueItem(String referenceListValueItem) {
    ...
    public void setReferenceListValue(List<String> referenceListValue) {
    ...
    public RunPropertyV0Attributes addIntegerListValueItem(Long integerListValueItem) {
    ...
    public void setIntegerListValue(List<Long> integerListValue) {
