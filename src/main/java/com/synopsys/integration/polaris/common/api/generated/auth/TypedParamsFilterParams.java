...
import com.synopsys.integration.polaris.common.api.generated.auth.FilterParams;
...
public class TypedParamsFilterParams extends PolarisComponent {
    ...
    public TypedParamsFilterParams putParamsItem(String key, FilterParams paramsItem) {
        if (this.params == null) {
    ...
    public void setParams(Map<String, FilterParams> params) {
        this.params = params;
    }
