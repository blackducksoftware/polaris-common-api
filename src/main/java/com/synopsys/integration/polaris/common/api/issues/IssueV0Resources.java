...
public class IssueV0Resources extends PolarisComponent {
    ...
    public IssueV0Resources addDataItem(final IssueV0 dataItem) {
    ...
    public void setData(final List<IssueV0> data) {
        this.data = data;
    }

    public IssueV0Resources addIncludedItem(final JsonApiIncludedResource includedItem) {
